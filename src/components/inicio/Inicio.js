...
const Inicio = () => {
    ...
    /* console.log(mundial) */
    /* console.log("RESULTADO GENERAL: ",resultadosSeccion) */
    return (
        <div >
            <Formik
                ...
                onSubmit={(fields, { setSubmitting }) => {
                    ...
                    console.log("Fields: ", resultadosSeccion)
                    console.log("Fields 2: ", fields)
                    alert('DATOS ENVIADOS')

                    setSubmitting(false);
                    /* setTimeout(() => {
                        alert(JSON.stringify(resultadosSeccion, null, 2));
                        setSubmitting(false);
                    }, 400); */
                }}
            >
                {({
                    ...
                    <Form>
                        ...
                        <br />
                        {/* Final */}
                        <div style={{textAlign: 'center'}}> <h1 className="title-octavos">Gran Final</h1> </div>
                        <div className="container-octavos">
